...
class KeyRing:
    ...
    def set_creds(self):
        ...
        while match is False:
            password1 = getpass("Enter your user password: ")
            password2 = getpass("Confirm your user password: ")
            if password1 == password2:
                user_password = password1
                match = True
        match = False
        while match is False:
            password1 = getpass("Enter your enable password: ")
            password2 = getpass("Confirm your enable password: ")
            if password1 == password2:
                enable_password = password1
                match = True
        user_pass = keyring.set_password(
            "nl_user_pass", username=self.username, password=user_password
        )
        enable_pass = keyring.set_password(
    ...
    def del_creds(self):
        ...
        while tries <= max_tries:
            ...
            if user_pass == ask_pass:
                print("Deleting keyring credentials for {}".format(self.username))
